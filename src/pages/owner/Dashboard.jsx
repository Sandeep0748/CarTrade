  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title
        ...
        subTitle="Monitor platform performance including total cars, bookings, revenue, and recent booking activities"
      />
              ...
              <div className='flex items-center gap-2'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-500'>
                    {booking.createdAt.split('T')[0]} | {booking.city || "Unknown City"}
                  </p>
                </div>
              </div>
