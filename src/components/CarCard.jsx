...
const CarCard = ({ car }) => {
  ...
  return (
    <div onClick={() => {navigate(`/cars-details/${car._id}`); scrollTo(0,0)}}
      ...
      <div className='relative h-48 overflow-hidden flex flex-col justify-between'>
        ...
        {(car.isAvaliable || car.isAvailable) && (
      ...
      <div className='p-4 sm:p-5'>
        ...
        <div className='mt-4 grid grid-cols-2 gap-y-2 text-gray-600'>
          <div className='flex items-center text-sm text-muted-foreground'>
            <img src={assets.users_icon} alt="Gas Icon" className='h-4 mr-2'/>
            <span>{car.seating_capacity} Seats</span>
          </div>
          <div className='flex items-center text-sm text-muted-foreground'>
            <img src={assets.fuel_icon} alt="Gas Icon" className='h-4 mr-2'/>
            <span>{car.fuel_type}</span>
          </div>
          <div className='flex items-center text-sm text-muted-foreground'>
            <img src={assets.car_icon} alt="Gas Icon" className='h-4 mr-2'/>
            <span>{car.transmission}</span>
          </div>
          <div className='flex items-center text-sm text-muted-foreground'>
            <img src={assets.location_icon} alt="Gas Icon" className='h-4 mr-2'/>
